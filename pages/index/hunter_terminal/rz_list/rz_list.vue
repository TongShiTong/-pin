				...
				<view class="re_info">
					<view>
						...
						<view class="info">
							...
							<view style="color: #999999;font-size: 22upx;">
								<span>{{item.entry_date}} | {{item.entry_date | getWeek}}</span>
							</view>
						</view>
					</view>
					<!-- <view @tap="liZhi" :data-index="index"><image style="width: 10upx;height: 36upx;" src="/static/sandian.png"></image></view>
	...
	export default {
		...
		methods: {
			...
			lzRenyuan() {
				uni.navigateTo({
					// 传递 userid 在详情页接收
					url: '/pages/index/hunter_terminal/lz_list/lz_list?itemid=' + this.itemid +'&isjiesuan=' + this.isjiesuan
				});
			},
			// 离职
			liZhi(e) {
