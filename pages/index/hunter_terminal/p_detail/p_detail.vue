	...
	<view class="content-box">
		...
		<uni-popup :radius="radius" ref="popup" type="bottom">
			<view class="biaoti-box">
				<image style="width: 160upx; height: 160upx;margin-right: 30upx;" :src="userInfo.avatar" mode="aspectFill"></image>
				<view class="biaoti">
		...
		<view class="baos-an" v-if="jiedan==1">
			<view class="an1" @click="openPopup" v-if="task==null">立即接单</view>
